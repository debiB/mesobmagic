document.getElementById("recipeForm").addEventListener("submit", function(event) {
  ...
  function authorName() {
    ...
    if (authorNameInput.value.trim() === "") {
      ...
      return false;
    } else if (!alphanumericRegex.test(authorNameInput.value)) {
      authorNameError.textContent = "Invalid author name. Author name should only contain alphanumeric characters, whitespace, and hyphen.";
      return false;
    } else {
      authorNameError.textContent = ""; // Clear any previous error message
      return true;
    }
  }
